...
export default function CampaignDetails({
  ...
  // Use a stable interval with a functional update to avoid adding
  // `nextSlide` to the effect dependency array.
  const prevSlide = () => {
      ...
      <Flex direction="column" gap="6">
        <Flex direction="column" gap="2" alignItems="flex-start">
          <Flex alignItems="center" gap="3">
            <Image
              src="/campaign/hero-graphic.svg"
              alt="Campaign hero"
              boxSize={{ base: "40px", md: "64px" }}
            />
                ...
                <Flex direction="column" gap={6}>
                  ...
                  <Box>
                    <Text fontSize="sm" mb="2">
                      Progress toward goal: {progress?.toFixed?.(2) || 0}%
                    </Text>
                    <Progress
                      value={progress}
                      size="lg"
                    ...
                    <Flex justify="space-between" mt="2" fontSize="sm">
                      <Text>Coverage: {Math.min(100, Math.round(progress || 0))}%</Text>
                      <Text>Skill completion milestones: TBD</Text>
                    </Flex>
                  </Box>
